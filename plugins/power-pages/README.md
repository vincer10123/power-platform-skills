...
Integrates Power Pages generative-AI summarization APIs into a Single Page Application (SPA) site: the **Search Summary API** (`/_api/search/v1.0/summary`), the **Data Summarization API** (`/_api/summarization/data/v1.0/...`), and the canonical **Case-page Copilot preset** for the incident table.
